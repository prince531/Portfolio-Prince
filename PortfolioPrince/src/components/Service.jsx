...
const services = [
    ...
    },
    {
        ...
        description: "Combining both frontend abd backend developement skills.",
    },
    {
        id: 5,
    ...
    },
    {
        ...
        description: "Promote your bussiness with our digital markiting team.",
    },
            ...
            <div className='container mx-auto px-8 md:px-16 lg:px-24'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
                    {services.map(service => (
                        <div key={service.id}
                            className='bg-gray-800 px-6 pb-6  rounded-lg hover:shadow-lg transform trangisition-transform duration-300 hover:scale-105'>
